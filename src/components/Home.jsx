      ...
      <div className="flex justify-center">
        <div className="flex flex-col max-w-[1040px] w-full ml-[-100px]">
          ...
          <div className='flex gap-x-10 mb-5'>
            {arr.map((item, index) => (
              <div className='flex flex-col border-[1px] border-black h-[200px]   rounded-2xl items-center hover:bg-[#24d4e5] cursor-pointer hover:text-white w-[330px]' key={index}>
